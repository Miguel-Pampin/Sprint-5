...
function getPoints(id) {
    var _a;
    var punctuation = id;
    var textDate = new Date().toISOString();
    var lastJoke = (_a = document.getElementById("joke")) === null || _a === void 0 ? void 0 : _a.outerText;
    var textLastJoke = lastJoke;
    var jokeIndex = reportJokes.findIndex(function (e) { return textLastJoke === e.joke; });
    var joke = { joke: textLastJoke, score: punctuation, date: textDate };
